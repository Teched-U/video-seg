...
class AudioFeatureExtractor():
    ...
    def get_features(self, video_path, N_sample_frames = 5, sample_Len = None):
        ...
        emb_list, ts_list = openl3.get_audio_embedding(audio_list, sr, batch_size=8, embedding_size=512)
